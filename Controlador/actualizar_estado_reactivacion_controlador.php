...
$id_estado = $_GET['id_estado_reactivacion'];
...
$sqlexiste = ("select count(estado) as estado  from tbl_estado_reactivacion where estado='$estado' and id_estado_reactivacion<>'$id_estado' ;");
