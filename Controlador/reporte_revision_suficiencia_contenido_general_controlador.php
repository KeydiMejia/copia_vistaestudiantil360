...
class myPDF extends FPDF
{
    ...
    function header()
    {
        ...
        $this->Cell(330, 10, utf8_decode("SOLICITUDES EXAMEN SUFICIENCIA POR CONTENIDO"), 0, 0, 'C');
        $this->ln(17);
    ...
    function viewTable()
    {
        ...
        $sql = "SELECT row_number() OVER (ORDER BY nombres) AS NP, p.nombres, p.apellidos, c.correo,
         c.observacion, c.tipo, c.fecha_creacion, l.descripcion FROM tbl_examen_suficiencia c, tbl_personas p,
          tbl_estado_suficiencia l WHERE p.id_persona=c.id_persona and c.id_estado_suficiencia= l.id_estado_suficiencia 
          and c.tipo= 'contenido'";
