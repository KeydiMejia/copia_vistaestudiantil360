...
class myPDF extends FPDF
{
    ...
    function header()
    {
        ...
        $this->Cell(330, 10, utf8_decode("SOLICITUDES REACTIVACION DE CUENTA"), 0, 0, 'C');
        $this->ln(17);
    ...
    function viewTable()
    {
        ...
        $sql = "SELECT row_number() OVER (ORDER BY nombres) AS NP, p.nombres, p.apellidos, c.correo, 
        c.observacion, c.fecha_creacion, l.descripcion FROM tbl_reactivacion_cuenta c, tbl_personas p, 
        tbl_estado_reactivacion l WHERE p.id_persona=c.id_persona 
        and c.id_estado_reactivacion= l.id_estado_reactivacion ";
...
$pdf->SetTitle('SOLICITUD_DE_REACTIVACION_CUENTA.PDF');
