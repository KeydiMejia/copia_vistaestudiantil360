...
$sql=" DELETE FROM tbl_examen_suficiencia where correo=$correo ";
  //$sql = "call proc_eliminar_estado_reactivacion('$estado'); ";
      ...
      bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'],'ELIMINO' , 'EL ESTADO  '.ctype_upper($estado).'');
                        	...
                        	echo '<script type="text/javascript">
                              swal({
                                ...
                                $(".FormularioAjax")[0].reset();
               window.location = "../vistas/mantenimiento_estado_reactivacion_vista.php";
