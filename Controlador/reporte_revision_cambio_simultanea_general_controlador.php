...
class myPDF extends FPDF
{
    ...
    function header()
    {
        ...
        $this->Cell(330, 10, utf8_decode("SOLICITUDES CAMBIO DE CARRERA SIMULTANEA"), 0, 0, 'C');
        $this->ln(17);
    ...
    function viewTable()
    {
        ...
        WHERE p.id_persona=c.id_persona and c.tipo= 'simultanea'";
...
$pdf->SetTitle('SOLICITUD_CAMBIO_CARRERA_SIMULTANEA.PDF');
