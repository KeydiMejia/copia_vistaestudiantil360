            ...
            <div class="card-body">
              <table id="tabla" class="table table-bordered table-striped">
                ...
                <td style="text-align: center;">                    
                    ...
                    <a href="../Controlador/Reporte_especialidades.php?cambio=<?php echo base64_encode($sql_tabla["ROWS"][$counter]["Id_cambio"]); ?>" target="_blank" class="btn btn-danger btn-raised btn-xs">
