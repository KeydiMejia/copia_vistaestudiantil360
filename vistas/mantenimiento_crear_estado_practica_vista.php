    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1>Estado de Practica Profesional</h1>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="../vistas/mantenimiento_estado_practica_vista.php"> Mantenimiento Estado</a></li>
                        </ol>
                    </div>
        ...
        <section class="content">
            <div class="container-fluid ">
                ...
                <form action="../Controlador/guardar_estado_practica_controlador.php" method="post" data-form="save" class="FormularioAjax" autocomplete="off">
