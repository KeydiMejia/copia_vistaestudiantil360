...
if(isset($_GET['alumno'])){
    ...
    $sql="SELECT tbl_personas_extendidas.valor, tbl_personas.nombres, tbl_personas.apellidos, tbl_cambio_carrera.correo, tbl_cambio_carrera.tipo, tbl_cambio_carrera.aprobado, 
    ...
    $sql="select tbl_personas.id_persona, observacion, aprobado,tbl_personas.nombres, 
