...
if(isset($_GET['alumno'])){
    ...
    $sql="SELECT nombre_proyecto,valor, nombres, apellidos,observacion, tbl_servicio_comunitario.id_servicio_comunitario, tbl_personas.id_persona,
          tbl_servicio_comunitario.nombre_proyecto,tbl_servicio_comunitario.id_estado_servicio,tbl_servicio_comunitario.fecha_creacion,tbl_servicio_comunitario.documento
    ...
    $consulta="SELECT nombre_proyecto, valor, nombres, apellidos,observacion, tbl_servicio_comunitario.id_servicio_comunitario, 
